  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["search-search-module"], {
    ...
    function srcAppSearchSearchModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      SearchPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], _search_routing_module__WEBPACK_IMPORTED_MODULE_5__["SearchPageRoutingModule"]],
    ...
    function srcAppSearchSearchPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var SearchPage = /*#__PURE__*/function () {
        function SearchPage(http, navCtrl, route, router, formBuilder) {
        ...
        _createClass(SearchPage, [{
          ...
          value: function addCriteria() {
            ...
            if (!this.formcriteria.valid) {
              ...
              var i = this.criteria.find(function (e) {
                return e['campo'] === _this.formcriteria.value['campo'];
              });
          ...
          key: "removeCriteria",
          value: function removeCriteria(a) {
            this.criteria.splice(this.criteria.findIndex(function (e) {
              return e === a;
            }), 1);
          ...
          value: function changeType() {
            if (this.criteria.find(function (o) {
              return o['campo'] === "ItemType";
            })) {
              this.criteria.splice(this.criteria.findIndex(function (o) {
                return o['campo'] === "ItemType";
              }), 1);
            }
          ...
          value: function process() {
            ...
            console.log("c ", c);
            this.http.searchEditions(c).subscribe(function (res) {
              _this2.items = res['body']['body'];
              _this2.numres = res['itemCount'] || res['body']['itemCount'];
              console.log(_this2.numres);
            }, function (error) {
              console.error(error);
              _this2.numres = 0;
            });
